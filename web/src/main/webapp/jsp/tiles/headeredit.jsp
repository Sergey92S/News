...
<table align="center" width="95%">
    ...
    <td>
        <form>
            ...
            <table>
                <td>
                    <a href="?command=edit&result=${result2}&option=${news.getId()}&language=en" ${language == 'en' ? 'selected' : ''}>English</a>
                </td>
                <td>
                    <a href="?command=edit&result=${result2}&option=${news.getId()}&language=ru" ${language == 'ru' ? 'selected' : ''}>Russian</a>
                </td>
            </table>
            </c:forEach>
        </form>
