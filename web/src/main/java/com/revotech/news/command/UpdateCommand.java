...
public class UpdateCommand extends ActionCommand {
    private static Logger logger = Logger.getLogger(UpdateCommand.class.getName());
    private String page;
    private int id;
    ...
    public String execute(HttpServletRequest request, List<FileItem> multiParts) {
                    ...
                    try {
                        for (FileItem item : multiParts) {
                            if (!item.isFormField()) {
                                ...
                                if(item.getFieldName().equals(OPTION_ATTRIBUTE)){
        ...
        logger.debug("UpdateCommand returned: " + page);
        return page;
    }
